...
public class FormValidacaoModel : IValidatableObject
{
    ...
    [RegularExpression(@"\d{11}", ErrorMessage = "CPF deve conter 11 dígitos (apenas números).")]
    ...
    [Required(ErrorMessage = "Selecione pelo menos um tipo de via.")]
